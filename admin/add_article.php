    ...
    <form name="ajout" action="add_article.php" method="post" class="form-horizontal">
        <div class="form-group">
            <div class="col-xs-4">
                ...
                <input class="form-control" placeholder="Votre pseudo" name="pseudo" id="pseudo" type="text" value="<?php if (isset($pseudo)) echo $pseudo; ?>" />
        ...
        <div class="form-group">
            <div class="col-xs-4">
                ...
                <input value="<?php if (isset($titre)) echo $titre; ?>" placeholder="Votre tire" class="form-control" name="titre" id="titre" type="text" />
        ...
        <div class="form-group">
            <div class="col-xs-4">
                ...
                <textarea rows="4" class="form-control" id="article" name="article" placeholder="Rédiger un article"><?php if (isset($article)) echo $article; ?></textarea>
