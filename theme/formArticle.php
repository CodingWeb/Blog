...
<form name="form" class="form-horizontal" action="index.php" method="post" role="form">
    <div class="form-group">
        <div class="col-sm-4">
            ...
            <input value="<?php if (isset($pseudo)) echo $pseudo;?>" type="text" name="pseudo" id="pseudo" placeholder="Entrer votre pseudo" class="form-control">
    ...
    <div class="form-group">
        <div class="col-sm-4">
            ...
            <input value="<?php if (isset($titre)) echo $titre;?>" type="text" placeholder="Entrer votre titre" name="titre" id="titre" class="form-control">
